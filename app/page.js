  ...
  return (
    <>
      ...
      <div className="bg-cover min-h-screen bg-[url('/home.jpg')] relative">
        ...
        <main className="min-h-[50vh] flex flex-col items-center justify-center z-10 relative">
          ...
          <div className="mt-20">
            <Link
              href="/Blog"
              className="text-1xl text-slate-100 border rounded-md py-3 px-4 hover:bg-yellow-300 hover:text-slate-800  hover:border-yellow-300 transition"
            >
              Read Blog
            </Link>
          </div>
      ...
      <section className="bg-slate-700 bg-opacity-90 absolute w-full z-20">
        <SiteFooter className="header-blog-home z-10 relative" />
      </section>
    </>
  );
}
